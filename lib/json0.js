 ...
 */
var json = {
  name: 'json0-datavis-tech',
  uri: 'http://sharejs.org/types/JSONv0-datavis-tech'
};
...
// Expose this as it's useful outside the library.
json.transformCursor = function(position, c, side){
  if (c.si != null || c.sd != null) {
    convertFromText(c);
    var transformed = text.transformCursor(position, c.o, side);
    convertToText(c);
    return transformed;
  }
  return position;
